...
COALESCE(val1, val2, ...): Hàm này cực kỳ hay, nó trả về giá trị không NULL đầu tiên trong danh sách. Rất hữu ích khi ta muốn hiển thị một giá trị thay thế nếu dữ liệu bị trống.
